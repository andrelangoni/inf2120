...
public class ABR<E extends Comparable<E>> {
  ...
  public int recherche(ABR<E> racine, E element) throws ElementIntrouvableException {
    int hauteur = 0; // hauteur de l'element dans l'arbre
    int direction = element.compareTo(racine._element);

    System.out.print(String.valueOf(racine._element) + " ");
    ...
    if ((direction != 0) && (racine._gauche == null) && (racine._droite == null)) {
